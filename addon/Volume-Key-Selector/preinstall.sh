...
keytest() {
  ...
  ui_print "  如果你的设备是没有对应按键的，例如WSA，点击屏幕即可自动执行默认干净安装"
  ui_print "  If your device does not have a physical button, such as WSA, tap the screen to automatically perform the default clean installation.  "
